...
class Help extends Component {
  ...
  render() {
    ...
    try {
      var text1 = commonData.help;
      var text2 = commonData.The_essentials_in_brief;
    } catch (error) {
      console.log(error);
    }
    ...
    return (
      <View style={styles.flexFull}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <Background>
            <TextHeader text1={text1} style={style.textHeader} />
            <HeadLine style={style.headLine1} text={text2} />
            <Carousel
              data={data1}
              ref={this.carousel}
