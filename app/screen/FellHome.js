...
class FellHome extends Component {
  constructor(props) {
    super(props);
  ...
  gotoScreenWithParam = (typeFell) => {
    ...
    functions.gotoScreenWithParam(data, this.props.navigation, "HomeScreen");
  };
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <Background>
            ...
            <View style={[styles.fullWith, style.root]}>
              <Href onPress={() => this.gotoScreenWithParam(1)}>
                <SvgXml xml={svgCode1} width="50" height="70" />
              </Href>
              <Href onPress={() => this.gotoScreenWithParam(2)}>
                <SvgXml xml={svgCode2} width="50" height="70" />
              </Href>
              <Href onPress={() => this.gotoScreenWithParam(3)}>
                <SvgXml xml={svgCode3} width="50" height="70" />
              </Href>
              <Href onPress={() => this.gotoScreenWithParam(4)}>
                <SvgXml xml={svgCode4} width="50" height="70" />
              </Href>
              <Href onPress={() => this.gotoScreenWithParam(5)}>
                <SvgXml xml={svgCode5} width="50" height="70" />
              </Href>
            </View>
            <BackNext
