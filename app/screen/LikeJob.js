...
class LikeJob extends Component {
  constructor(props) {
    super(props);
  }
  ...
  getListJobLike = () => {
    ...
    try {
      global.commonData.listJoBlike.map((item, index) => {
        var object = {};
        ...
        <ScrollView contentContainerStyle={styles.scroll}>
          <Background>
            ...
            <View style={style.view1}>
              ...
              <Text style={[styles.fontBoldNormal, style.text1]}>
                Favoriten
              </Text>
            </View>
                ...
                return (
                  <Href
                    onPress={() =>
                      functions.gotoScreenWithParam(
                        JSON.stringify(global.commonData.listJoBlike[index]),
                  ...
                  >
                    <View style={style.parent}>
                      {hasMessage ? (
                        <Image style={style.message} source={imgMessage} />
                      ) : null}
                      <Image source={imgHeart} />
