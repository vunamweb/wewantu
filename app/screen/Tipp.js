...
class Tipp extends Component {
  ...
  render() {
    ...
    try {
      var text1 = commonData.tipps;
      var text2 = commonData.tricks;
      var text3 = commonData.Your_job_coach;
    } catch (error) {
      console.log(error);
    }
    ...
    return (
      <View style={styles.flexFull}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <Background>
            <TextHeader text1={text1} text2={text2} style={style.textHeader} />
            <HeadLine style={style.headLine1} text={text3} />
            <Carousel
              data={data1}
              ref={this.carousel}
